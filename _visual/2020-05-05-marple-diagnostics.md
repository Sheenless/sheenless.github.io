...
subtitle: "Mobile and Real-time dianostic platform"
date: 2018-08-13
image: "https://res.cloudinary.com/dx9f6wyoq/image/upload/v1784842705/IMG_9479_ovpnax.jpg"
tags: [logo, website, photography, video, typesetting]
---

I have worked for many years with Diane Saunders (John Innes Centre) on the branding, graphic design, article writing, photography, videography and website for MARPLE Diagnostics.

## MARPLE Diagnostics

Wheat is one of the world's major crops, supplying around 20% of calories. These harvest are threatened each year by damage from fungal diseases called wheat 'rusts'. The greatest way to protect wheat harvests from being infected is to grow wheat varieties with innate resistance, but new rust strains are constantly developing which could overcome this resistance. Just like with the human flu virus, the best way to stay ahead of the rusts is to track the emerging new strains, and plan disease prevention control accordingly.

The challenge is that many lab globally lack the equipment to track rust strains. This is where MARPLE comes in.

Mobile And Real-time PLant disEase (MARPLE) Diagnostics is an all-in-one mobile lab set up to identify wheat rust strains within 48 hours. The entire set up is so mobile that it can run on battery power and be conducted from the field site. 

Diane was later named the 2019 BBSRC Innovator of the Year for international impact for developing the platform.

## Visual content

I was brought in to help the MARPLE platform improve its visibility, with the priority being a logo, branding and photos of the work. This work would coincide with the first use and teaching of the platform in the field, starting with Ethiopia on account of it being the largest producer of wheat in Africa. I also followed the training for this work in Kenya - both for Kenyan's and other international teams.

### Logo and graphics

The scope for the logo was to include several elements which were integral to the project: 

* Plant heath
* Rust or pathogens of some kind
* Research
* Genetics 
...
It's busy and there's probably too much going on but we seemed to get away with it.
...
Most of these infections are little to worry about. They are strains that are known in the country for which there might be resistant varieties the farmer could grow instead. Farmers do not always grow resistant varieties, but at least they have the option if the rust pressure becomes too strong.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/CzA94VvcXWY?si=1kYazYHo9uBSlsSI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

## Website

Most of the MARPLE materials were hosted on the John Innes Centre website, but eventually we decided there was enough content to build a [separate website](https://marple-diagnostics.org/).

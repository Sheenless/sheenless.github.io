---
layout: post
title: "How to plan impact measurement"
subtitle: "An intro guide to planning and measuring impact"
date: 2023-04-07
image: "https://miro.medium.com/v2/resize:fit:828/format:webp/1*KfklyINQKDPV_-KI4oo5qQ.jpeg"
...
![Figure 1](https://miro.medium.com/v2/resize:fit:828/format:webp/1*XuEFInGr5xuwEXzKTTwDyQ.png)
...
You can make these indicators up yourself. Alternatively, there are many examples of indicators online people have used before. The [WorldBank indicators](https://data.worldbank.org/indicator) give some examples and you’ll quickly find indicators in other impact reports or online. If you find indicators elsewhere that fit with your project, that might also give you something to compare against. This idea of comparison brings us on to a very important point.
...
![Figure 2](https://miro.medium.com/v2/resize:fit:828/format:webp/1*ppvRLIcbGYvNVR9f_JCxZA.jpeg)
...
![Figure 4](https://miro.medium.com/v2/resize:fit:828/format:webp/1*PQdglV8k_PES1Fg1EcrWHQ.jpeg)
...
As mentioned above, a project could lead to unexpected changes — good or bad. While indicators give us some ideas of what to look for, we must not be so bound by them that we fail to notice other effects. Qualitative data capture methods are particularly good for uncovering these unexpected results. These kinds of findings can be used in [case studies](https://www.jstor.org/stable/44148783) that add to impact reporting.
...
![Figure 5](https://miro.medium.com/v2/resize:fit:828/format:webp/1*zxW7mJyJFrSur9Vow0o03Q.png)
...
Clearly this example uses a limited number of indicators and yours will be more detailed, but the principle is the same. [Here’s a copy of the measurement framework spreadsheet](https://docs.google.com/spreadsheets/d/1R4ltb-TrLpXSS3VGpqqPDwAefHzAuM9d/edit?usp=sharing&ouid=108276877609406666390&rtpof=true&sd=true) you can use to save you some time. Once you have your logframe/theory of change, you’ll find it surprisingly fast to fill out the form.

---
layout: post
title: "Language for impact strategy"
subtitle: "what do we mean by impact?"
date: 2023-04-04
image: "https://miro.medium.com/v2/resize:fit:828/format:webp/1*SIWxWxpWSZq9mgIGcTnNAw.jpeg"
...
![figure 1](https://miro.medium.com/v2/resize:fit:828/format:webp/1*g8ab3wQsiOw1JrNQD9CEiQ.png)
...
![Figure 2](https://miro.medium.com/v2/resize:fit:828/format:webp/1*g4ryAmOMrxm3J9TO4Icvhg.jpeg)
...
Outputs are the first step on the way. They are useful to track but the interesting part starts with _what happens next_ as a result. We call these next steps, “outcomes”.

![Figure 3](https://miro.medium.com/v2/resize:fit:828/format:webp/1*s5ji_HoCGIkeX4YbNOgPPg.jpeg)
...
![Figure 4](https://miro.medium.com/v2/resize:fit:828/format:webp/1*-xSeUtEnBUv9EJmMpe264w.png)
<sub>HH = households. I’ve added intermediate and high-level qualifiers to some of the outcomes to help us refer to them. These are just examples but any similar terminology would suffice. e.g. ‘primary/secondary’, ‘near-term/long-term’ , etc.</sub>
...
Measuring outcomes is closer to our impact, but the _ease_ and _clarity_ of measuring outputs often lulls us into reporting outputs. As with the example reporting the numbers of farmers trained, this can problematic.

![Figure 5](https://miro.medium.com/v2/resize:fit:720/format:webp/1*O-Odf7SQlmpzA6nPkns4IQ.jpeg)
...
Now we have an entry into how to break down impact planning and measurement. Remember, the real _impact_ we want is right at the end. To get there, we start with the _outputs_ and we’re interested in the _outcomes_ that happen as a result. These outcomes lead eventually to our impact.

In the next section, we’ll start making more detailed plans to aid our [planning and measurement strategy](https://medium.com/@Matt.Heaton/impact-mle-101-mapping-impact-pathways-f30b35e80379).

---

< [Introduction](https://medium.com/@Matt.Heaton/impact-mle-101-an-intro-guide-to-planning-and-measuring-impact-253500d1373a) | [Next section](https://medium.com/@Matt.Heaton/impact-mle-101-mapping-impact-pathways-f30b35e80379) >
